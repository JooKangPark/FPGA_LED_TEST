...
# set_property -dict { PACKAGE_PIN K18   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_d_n_0 }]; #IO_L12N_T1_MRCC_35 Sch=hdmi_tx_d_n[0]
# set_property -dict { PACKAGE_PIN K17   IOSTANDARD TMDS_33  } [get_ports { hdmi_tx_d_p_0 }]; #IO_L12P_T1_MRCC_35 Sch=hdmi_tx_d_p[0]
